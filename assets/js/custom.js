...
function sendEmail() {
    ...
    var body = "Please subscribe me to your newsletter.";

    // Ganti dengan alamat email Gmail yang dituju
    var toEmail = "andyas2003@gmail.com";

    // Membuat URL mailto dengan subjek dan badan pesan
    var mailtoLink = "mailto:" + encodeURIComponent(toEmail) + "?subject=" + encodeURIComponent(subject) + "&body=" + encodeURIComponent(body + " Email: " + email);

    // Membuka link mailto di tab atau jendela baru
